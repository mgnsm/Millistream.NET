...
#pragma warning disable IDE1006
    internal class NativeLinuxImplementation : INativeImplementation
    {
        private static class NativeLinuxMethods
        {
            ...
            [DllImport(DllName, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl)]
            public static extern int mdf_message_add_list(IntPtr message, uint tag, IntPtr value);
            ...
            [DllImport(DllName, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl)]
            public static extern int mdf_message_add_date(IntPtr message, uint tag, IntPtr value);

            [DllImport(DllName, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl)]
            public static extern int mdf_message_add_date2(IntPtr message, uint tag, int year, int mon, int day);

            [DllImport(DllName, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl)]
            public static extern int mdf_message_add_time(IntPtr message, uint tag, IntPtr value);
        ...
        public int mdf_connect(IntPtr handle, IntPtr server) => NativeLinuxMethods.mdf_connect(handle, server);
        ...
        public int mdf_message_add_date(IntPtr message, uint tag, IntPtr value) => NativeLinuxMethods.mdf_message_add_date(message, tag, value);
        ...
        public int mdf_message_add_list(IntPtr message, uint tag, IntPtr value) => NativeLinuxMethods.mdf_message_add_list(message, tag, value);
        public int mdf_message_add_numeric(IntPtr message, uint tag, IntPtr value) => NativeLinuxMethods.mdf_message_add_numeric(message, tag, value);
        public int mdf_message_add_string(IntPtr message, uint tag, IntPtr value) => NativeLinuxMethods.mdf_message_add_string(message, tag, value);
        public int mdf_message_add_string2(IntPtr message, uint tag, IntPtr value, int len) => NativeLinuxMethods.mdf_message_add_string2(message, tag, value, len);
        public int mdf_message_add_time(IntPtr message, uint tag, IntPtr value) => NativeLinuxMethods.mdf_message_add_time(message, tag, value);
        ...
        public int mdf_message_deserialize(IntPtr message, IntPtr data) => NativeLinuxMethods.mdf_message_deserialize(message, data);
