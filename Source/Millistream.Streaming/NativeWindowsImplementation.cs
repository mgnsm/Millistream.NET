...
#pragma warning disable IDE1006
    internal class NativeWindowsImplementation : INativeImplementation
    {
        ...
        public int mdf_connect(IntPtr handle, IntPtr server) => NativeWindowsMethods.mdf_connect(handle, server);
        ...
        public int mdf_message_add_date(IntPtr message, uint tag, IntPtr value) => NativeWindowsMethods.mdf_message_add_date(message, tag, value);
        ...
        public int mdf_message_add_list(IntPtr message, uint tag, IntPtr value) => NativeWindowsMethods.mdf_message_add_list(message, tag, value);
        ...
        public int mdf_message_add_time(IntPtr message, uint tag, IntPtr value) => NativeWindowsMethods.mdf_message_add_time(message, tag, value);
        ...
        public int mdf_message_deserialize(IntPtr message, IntPtr data) => NativeWindowsMethods.mdf_message_deserialize(message, data);
