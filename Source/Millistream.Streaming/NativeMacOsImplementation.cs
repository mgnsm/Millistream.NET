...
#pragma warning disable IDE1006
    internal class NativeMacOsImplementation : INativeImplementation
    {
        ...
        public int mdf_get_property(IntPtr handle, MDF_OPTION option, ref long value) => NativeMacOsMethods.mdf_get_property(handle, option, ref value);
        ...
        public int mdf_message_add_date(IntPtr message, uint tag, IntPtr value) => NativeMacOsMethods.mdf_message_add_date(message, tag, value);
        ...
        public int mdf_message_add_list(IntPtr message, uint tag, IntPtr value) => NativeMacOsMethods.mdf_message_add_list(message, tag, value);
        public int mdf_message_add_numeric(IntPtr message, uint tag, IntPtr value) => NativeMacOsMethods.mdf_message_add_numeric(message, tag, value);
        public int mdf_message_add_string(IntPtr message, uint tag, IntPtr value) => NativeMacOsMethods.mdf_message_add_string(message, tag, value);
        public int mdf_message_add_string2(IntPtr message, uint tag, IntPtr value, int len) => NativeMacOsMethods.mdf_message_add_string2(message, tag, value, len);
        public int mdf_message_add_time(IntPtr message, uint tag, IntPtr value) => NativeMacOsMethods.mdf_message_add_time(message, tag, value);
