...
namespace Millistream.Streaming.Benchmarks
{
    internal static class DllImports
    {
        ...
        [DllImport(DllName, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl)]
        public static extern int mdf_message_get_num_fields(IntPtr message);

        [DllImport(DllName, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl)]
        public static extern int mdf_message_send(IntPtr handle, IntPtr message);

        [DllImport(DllName, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl)]
        public static extern int mdf_message_set_property(IntPtr message, MDF_MSG_OPTION option, int value);
        ...
        [DllImport(DllName, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl)]
        public static extern int mdf_message_deserialize(IntPtr handle, string data);
    }
}