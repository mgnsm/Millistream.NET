...
namespace Millistream.Streaming.Interop
{
    internal unsafe class NativeImplementation
    {
        ...
        internal delegate*<IntPtr, uint, string, int> mdf_message_add_date_str;
        ...
        internal delegate*<IntPtr, uint, string, int> mdf_message_add_time_str;
        ...
        internal delegate*<IntPtr, uint, string, int> mdf_message_add_list_str;
        ...
        internal delegate*<IntPtr, string, int> mdf_message_deserialize_str;
        ...
        internal NativeImplementation(string _)
        {
            ...
            mdf_message_deserialize_str = &MdfMessageDeserializeString;
        ...
        private static int MdfMessageAddDateString(IntPtr message, uint tag, string value) => Implementation.mdf_message_add_date_str(message, tag, value);
        ...
        private static int MdfMessageAddTimeString(IntPtr message, uint tag, string value) => Implementation.mdf_message_add_time_str(message, tag, value);
        ...
        private static int MdfMessageAddListString(IntPtr message, uint tag, string value) => Implementation.mdf_message_add_list_str(message, tag, value);
        ...
        private static int MdfMessageDeserializeString(IntPtr message, string data) => Implementation.mdf_message_deserialize_str(message, data);
